...
namespace FIX_LOGIN_REGISTER
{
    public partial class detail_dahliaII : Form
    {
        ...
        public detail_dahliaII(Login.User user)
        {
            InitializeComponent();
            this.user = user;
        }
        ...
        private void detail_dahliaII_Load(object sender, EventArgs e)
        {
            try
            {
                int id = 8;
        ...
        public void UpdateResult()
        {
            ...
            label154.Text = ("Total Harga = " + hasilPerkalian.ToString());
            label155.Text = ("x " + selisihHari.ToString() + " Malam");
            label153.Text = (("Tagihan Minimal = ") + hasilPerkalian * 1 / 4);
        }

        private void checkedListBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            UpdateResult(); label154.Visible = true; label155.Visible = true; label153.Visible = true;
        }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            using (NpgsqlConnection connection = new NpgsqlConnection("Host=localhost;Port=5432;Username=postgres;Password=;Database=Jecation"))
            {
                ...
                NpgsqlCommand command = new NpgsqlCommand();
                command.Connection = connection;
                command.CommandText = "insert into reservasi_penginapan (id_akun,jumlah_kamar,id_kamar, jadwal_masuk_penginapan, jadwal_keluar_penginapan, harga, harga_minimal , nama_kamar) values ( @id_akun,@jumlah_kamar, @id, @checkin, @checkout, @harga, @harga_minimal,'Dahlia I')";
