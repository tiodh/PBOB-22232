...
namespace FIX_LOGIN_REGISTER
{
    public partial class Ulasan : Form
    {
        ...
        {
            return new NpgsqlConnection(@"Server=localhost; Port=5432; Database=Jecation; User Id=postgres; Password=");
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            using (NpgsqlConnection conn = GetConnection())
            {
                ...
                command1.CommandText = "SELECT username_akun, isi_ulasan,rating,tanggal FROM ulasan ORDER BY id_ulasan DESC";
        ...
        public void btnkirimulasan_Click_1(object sender, EventArgs e)
        {
            try
            {
                using (NpgsqlConnection conn = GetConnection())
                {
                    ...
                    command.Connection = conn;
                    command.CommandText = "INSERT INTO ulasan (username_akun, id_ulasan, isi_ulasan, rating, tanggal, id_akun) VALUES (@username,DEFAULT, @isi_ulasan, @rating, @tanggal,@id_akun)";
                    //command.CommandText = "INSERT INTO ulasan (id_ulasan, isi_ulasan, rating, tanggal, id_detail_pemesanan, id_akun)\r\nVALUES (DEFAULT, @isi_ulasan, @rating, @tanggal, (SELECT id_detail_pemesanan FROM detail_pemesanan WHERE id_detail_pemesanan = @id_detail_pemesanan), @id_akun)";
        ...
        private void lbljudululasanpengunjung_Click(object sender, EventArgs e)
        {
