    ...
    public partial class melati_II : Form
    {
        ...
        private void melati_II_Load(object sender, EventArgs e)
        {
            ...
            using (NpgsqlConnection conn = new NpgsqlConnection("Server=localhost; Port=5432; User Id=postgres; Password=123; Database=final"))
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = "SELECT nama_fasilitas_kamar FROM fasilitas_kamar where id_kamar = 3 ORDER BY id_fasilitas_kamar ASC";
        ...
        private void fasilitas1_Click(object sender, EventArgs e)
        {
